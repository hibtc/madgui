...
latex_documents = [
    (master_doc, 'madgui.tex', 'madgui Documentation',
     'Thomas Gläßle', 'manual'),
]
...
man_pages = [
    (master_doc, 'madgui', 'madgui Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'madgui', 'madgui Documentation',
     author, 'madgui', 'One line description of project.',
     'Miscellaneous'),
]
